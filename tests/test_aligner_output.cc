...
TEST_F(AlignerOutput, Normal) {
  ...
  align_pb_reads(1, hash, 10, 2, false, false, false, pb_file, coords_file.path, details_file.path);
...
TEST_F(AlignerOutput, Forward) {
  ...
  frag_lists names(1);
  superread_parse(1, hash, names, sr_file);
  align_pb_reads(1, hash, 10, 2, false, true, false, pb_file, coords_file.path, details_file.path);
...
TEST_F(AlignerOutput, Compressed) {
  ...
  mer_pos_hash_type hash(super_read_approx_len * 2);
  frag_lists names(1);
  superread_parse(1, hash, names, sr_file, true);
  align_pb_reads(1, hash, 10, 2, true, false, false, pb_file, coords_file.path, details_file.path);
...
TEST_F(AlignerOutput, Duplicated) {
  ...
  frag_lists names(1);
  superread_parse(1, hash, names, sr_file);
  align_pb_reads(1, hash, 10, 2, false, false, true, pb_file, coords_file.path, details_file.path);
