...
counter=1;
minlen=31
until [ $nduplicates -lt 10 ] || [ $counter -gt 5 ];do
echo "Deduplication iteration $counter"
nucmer -t $NUM_THREADS -l $minlen -c 100 -b 400 -p $ASM_DIR/asm_to_asm  $ASM_DIR/unitigs.initial.fa  $ASM_DIR/unitigs.initial.fa && \
