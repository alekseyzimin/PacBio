...
merge_matches_and_tile_coords_file.pl 1000000 < $COORDS_FILE | awk 'BEGIN{last_end=0;last_scf="";}{if($18 != last_scf){last_end=0;last_scf=$18} if($2>last_end) print $0; last_end=$2}' |  awk '{if($16>5) print $0}' > $COORDS_FILE.merged
